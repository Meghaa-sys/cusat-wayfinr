...
const CUSAT_DATA = {
  ...
  landmarks: [
    ...
    // ================= Departmental Lab Blocks =================
    {
      id: 'soe_comp_lab',
      name: 'SOE Computer Engineering & GPU Computing Lab',
      shortName: 'SOE Computing Lab',
      category: 'lab',
      coords: [10.0415, 76.3284],
      description: 'Central computing facility for SOE CS/IT: 150+ high-end workstations, Linux kernel lab, NVIDIA GPU compute server, and competitive coding lab.',
      timings: '08:30 AM - 05:30 PM',
      phone: '+91 484 2556187',
      tags: ['lab', 'soe lab', 'computer lab', 'coding', 'gpu', 'linux', 'programming', 'soe cs lab'],
      image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'SOE Block C, 1st & 2nd Floor'
    },
    {
      id: 'soe_mech_workshop',
      name: 'SOE Central Mechanical Workshop & Robotics Lab',
      shortName: 'SOE Mech Workshop',
      category: 'lab',
      coords: [10.0412, 76.3292],
      description: 'Heavy industrial machining complex: Lathe, Milling, CNC machines, Welding, Foundry, IC Engines test rig, and Automation Robotics cell.',
      timings: '08:30 AM - 04:30 PM',
      phone: '+91 484 2556188',
      tags: ['lab', 'workshop', 'mech', 'mechanical', 'lathe', 'cnc', 'robotics', 'engines', 'welding', 'cad'],
      image: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'Ground Workshop Hangar'
    },
    {
      id: 'soe_civil_lab',
      name: 'SOE Civil Engineering & Fluid Mechanics Lab',
      shortName: 'Civil Structures Lab',
      category: 'lab',
      coords: [10.0419, 76.3290],
      description: 'Structural strength testing, Concrete testing, UTM, Total Station Surveying, Soil mechanics, and Open Channel Hydraulics flume.',
      timings: '08:30 AM - 04:30 PM',
      phone: '+91 484 2556189',
      tags: ['lab', 'civil', 'structures', 'concrete', 'survey', 'hydraulics', 'soil', 'utm'],
      image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'SOE Block B Ground Floor'
    },
    {
      id: 'soe_safety_lab',
      name: 'Safety & Fire Engineering Specialized Lab',
      shortName: 'Fire & Safety Lab',
      category: 'lab',
      coords: [10.0410, 76.3280],
      description: 'One of India\'s premier safety engineering labs: Fire simulation gallery, Smoke density measurement, Explosion dynamics, and Industrial Hazard analyzer.',
      timings: '08:30 AM - 04:30 PM',
      phone: '+91 484 2556187',
      tags: ['lab', 'safety', 'fire', 'smoke', 'hazard', 'explosion', 'industrial safety'],
      image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'Safety & Fire Dedicated Lab Block'
    },
    {
      id: 'dcs_ai_lab',
      name: 'DCS Artificial Intelligence & Cyber Security Lab',
      shortName: 'DCS AI & Cyber Lab',
      category: 'lab',
      coords: [10.0447, 76.3267],
      description: 'Postgraduate & Doctoral research facility for Deep Learning, Computer Vision, Cryptography, Blockchain, and Threat Intelligence.',
      timings: '09:00 AM - 06:00 PM',
      phone: '+91 484 2577126',
      tags: ['lab', 'dcs lab', 'ai lab', 'deep learning', 'cyber', 'security', 'crypto', 'blockchain'],
      image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'DCS Building 1st Floor'
    },
    {
      id: 'dca_software_lab',
      name: 'DCA Cloud Computing & Full-Stack Lab',
      shortName: 'DCA Software Lab',
      category: 'lab',
      coords: [10.0450, 76.3273],
      description: 'Advanced MCA lab equipped for Cloud Virtualization, Mobile App Development (Flutter/React Native), DevOps, and Microservices architecture.',
      timings: '09:00 AM - 05:30 PM',
      phone: '+91 484 2576253',
      tags: ['lab', 'dca lab', 'mca lab', 'cloud', 'software', 'app dev', 'devops', 'web'],
      image: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'DCA Building Ground & 1st Floor'
    },
    {
      id: 'doe_crema_lab',
      name: 'Centre for Research in Electromagnetics and Antennas (CREMA)',
      shortName: 'CREMA Antenna Lab',
      category: 'lab',
      coords: [10.0439, 76.3280],
      description: 'Nationally recognized Anechoic Chamber, Vector Network Analyzers (up to 50 GHz), Microstrip Antenna fabrication, and Planar Microwave circuits.',
      timings: '09:00 AM - 05:30 PM',
      phone: '+91 484 2576418',
      tags: ['lab', 'crema', 'antenna', 'microwave', 'anechoic', 'rf', 'electromagnetics', 'doe lab'],
      image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'Dept of Electronics Annex Block'
    },
    {
      id: 'doe_vlsi_lab',
      name: 'DoE VLSI & Embedded Systems Hardware Lab',
      shortName: 'VLSI & Embedded Lab',
      category: 'lab',
      coords: [10.0437, 76.3276],
      description: 'Cadence/Synopsys EDA design suite, FPGA development boards (Xilinx/Altera), ARM Cortex development kits, and Signal Processing DSP boards.',
      timings: '09:00 AM - 05:00 PM',
      phone: '+91 484 2576418',
      tags: ['lab', 'vlsi', 'embedded', 'fpga', 'eda', 'circuits', 'hardware', 'doe'],
      image: 'https://images.unsplash.com/photo-1507499739999-097706ad8914?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'Electronics Block 2nd Floor'
    },
    {
      id: 'biotech_genomics_lab',
      name: 'Biotechnology Genomics & Fermentation Lab',
      shortName: 'Biotech Research Lab',
      category: 'lab',
      coords: [10.0427, 76.3270],
      description: 'Bioreactors, High-speed centrifuges, PCR Thermal Cyclers, DNA sequencers, Plant Tissue Culture, and Bioactive Compound Extraction facilities.',
      timings: '09:00 AM - 05:30 PM',
      phone: '+91 484 2576267',
      tags: ['lab', 'biotech lab', 'genomics', 'fermentation', 'pcr', 'dna', 'bioreactor', 'tissue culture'],
      image: 'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'Biotechnology Main Building'
    },
    {
      id: 'physics_laser_lab',
      name: 'Physics Photonics, Laser & Nanotech Lab',
      shortName: 'Laser & Photonics Lab',
      category: 'lab',
      coords: [10.0436, 76.3260],
      description: 'Nd:YAG and He-Ne laser systems, Spectrofluorometer, Thin Film Deposition, Superconductivity cryogenic setups, and Solar Cell characterization.',
      timings: '09:00 AM - 05:00 PM',
      phone: '+91 484 2577404',
      tags: ['lab', 'physics lab', 'laser', 'optics', 'photonics', 'nanotech', 'thin film', 'superconductivity'],
      image: 'https://images.unsplash.com/photo-1507668077129-56e32842fceb?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'Physics Block Ground & 1st Floor'
    },
    {
      id: 'chem_spectro_lab',
      name: 'Applied Chemistry Spectroscopy & Analytical Lab',
      shortName: 'Chemistry Analytics Lab',
      category: 'lab',
      coords: [10.0434, 76.3256],
      description: 'FT-IR spectrometer, UV-Vis Spectrophotometer, Gas Chromatography (GC-MS), High Performance Liquid Chromatography (HPLC), and Organic Synthesis lab.',
      timings: '09:00 AM - 05:00 PM',
      phone: '+91 484 2577404',
      tags: ['lab', 'chemistry lab', 'spectroscopy', 'hplc', 'gcms', 'ftir', 'analytics', 'synthesis'],
      image: 'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'Chemistry Block 2nd Floor'
    },
    {
      id: 'psrt_polymer_lab',
      name: 'Polymer Science & Rubber Technology (PSRT) Lab',
      shortName: 'PSRT Rubber Tech Lab',
      category: 'lab',
      coords: [10.0424, 76.3274],
      description: 'Two-roll mixing mill, Hydraulic vulcanizing presses, Mooney Viscometer, Dynamic Mechanical Analyzer (DMA), and Rubber Rheometer.',
      timings: '09:00 AM - 05:00 PM',
      phone: '+91 484 2575723',
      tags: ['lab', 'psrt', 'rubber', 'polymer', 'vulcanization', 'rheometer', 'plastics', 'compounding'],
      image: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'PSRT Department Building'
    },
    {
      id: 'kmsme_engine_sim',
      name: 'KMSME Marine Engine Simulator & Ship Machinery Lab',
      shortName: 'Marine Engine Lab',
      category: 'lab',
      coords: [10.0403, 76.3304],
      description: 'Full-mission Kongsberg Marine Engine Room Simulator, Auxiliary Marine Boiler, 4-Stroke Diesel Power Plant, and Marine Electrical Automation bench.',
      timings: '08:00 AM - 05:00 PM',
      phone: '+91 484 2576622',
      tags: ['lab', 'marine lab', 'engine simulator', 'ship', 'boiler', 'diesel', 'kmsme lab', 'maritime'],
      image: 'https://images.unsplash.com/photo-1509718443690-d8e2fb3474b7?w=600&auto=format&fit=crop&q=80',
      floorInfo: 'KMSME Ship Complex & Simulator Wing'
    }
  ],
  ...
  landmarkToNode: {
    ...
    'soe_comp_lab': 'p_soe_avenue',
    'soe_mech_workshop': 'p_soe_south',
    'soe_civil_lab': 'p_soe_avenue',
    'soe_safety_lab': 'p_soe_avenue',
    'dcs_ai_lab': 'p_cs_junc',
    'dca_software_lab': 'p_dca_front',
    'doe_crema_lab': 'p_ece_front',
    'doe_vlsi_lab': 'p_ece_front',
    'biotech_genomics_lab': 'p_biotech_junc',
    'physics_laser_lab': 'p_physics_junc',
    'chem_spectro_lab': 'p_physics_junc',
    'psrt_polymer_lab': 'p_biotech_junc',
    'kmsme_engine_sim': 'p_marine_front'
  },
